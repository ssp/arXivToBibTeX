...
u"Hans-Christian Graf v. Bothmer":   dict(arXivID="grafvbothmer_h_1", default="", crcg=""),
u"Hans-Christian Graf von Bothmer":  dict(arXivID="grafvbothmer_h_1", crcg=""),
u"Hans-Christian Bothmer":           dict(arXivID="grafvbothmer_h_1", crcg=""),
u"Hans-Christian v. Bothmer":        dict(arXivID="grafvbothmer_h_1", crcg=""),
u"Hans-Christian von Bothmer":       dict(arXivID="grafvbothmer_h_1", crcg=""),
u"H.-Chr. Graf von Bothmer":         dict(arXivID="grafvbothmer_h_1", crcg=""),
u"H. -Chr. Graf von Bothmer":        dict(arXivID="grafvbothmer_h_1", crcg=""),
u"H.-C. Graf v. Bothmer":            dict(arXivID="grafvbothmer_h_1", crcg=""),
u"Jörg Brüdern":                     dict(default="", crcg=""),
u"Arne Buchholz":                    dict(default="", crcg=""),
...
u"Anders Jensen":                    dict(arXivID="jensen_a_1", default ="", crcg=""),
u"Anders N. Jensen":                 dict(crcg=""),
u"A. N. Jensen":                     dict(crcg=""),
u"Anders Nedergaard Jensen":         dict(crcg=""),
u"Alexander Kahle":                  dict(default="", crcg=""),
u"Du Li":                            dict(default="", crcg=""),
u"Hannah Markwig":                   dict(arXivID="markwig_h_1", default="", crcg=""),
u"H. Markwig":                       dict(arXivID="markwig_h_1", crcg=""),
...
u"Jakob Kröker":                     dict(default="", crcg=""),
...
u"Franziska Schroeter":              dict(default="", crcg=""),
...
u"Chenchang Zhu":                    dict(default="", arXivID="zhu_c_1", default="", crcg=""),
u"C. Zhu":                           dict(default="", arXivID="zhu_c_1", crcg=""),
